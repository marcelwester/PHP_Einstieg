...
if (priv("fb_tusteam"))
{
sitename("fbv_team_tus.php",$_SESSION["groupid"]);
?>
...
<!--
	function popup(teamid)
	{
		...
		if (teamid == 0)
<?php
			echo 'url = "fbv_team_tus_popup.php?action=add&PHPSESSID='.session_id().'";';
		echo ' else ';
			echo 'url = "fbv_team_tus_popup.php?action=edit&teamid="+teamid+"&PHPSESSID='.session_id().'";';
?>
...
<?php
	...
	echo '<CENTER><TABLE WIDTH="70%" BORDER="0">';
			...
			$sql = 'select * from fb_tus_mannschaft order by name';
