<?php
               // Statistiken Spielsystem 1 (Sechser Paarkreutz)
		   ...
		   echo '<TR>';
			   ...
			   echo '</TD>';
		   	   echo '<TD ALIGN="CENTER" BGCOLOR="#DDDDDD" COLSPAN="2">';
			   	echo '<B>Ob. Pk<br>Spiele/Sätze</B>';
			   echo '</TD>';
		   	   echo '<TD ALIGN="CENTER" BGCOLOR="#DDDDDD" COLSPAN="2">';
			   	echo '<B>Mit. Pk<br>Spiele/Sätze</B>';
			   echo '</TD>';
		   	   echo '<TD ALIGN="CENTER" BGCOLOR="#DDDDDD" COLSPAN="2">';
			   	echo '<B>Unt. Pk<br>Spiele/Sätze</B>';
			   echo '</TD>';
		   	   echo '<TD ALIGN="CENTER" BGCOLOR="#DDDDDD">';
			   	echo '<B>Gesamt<br>Spiele</B>';
			   echo '</TD>';
		   echo '</TR>';	
		...
		foreach ($result as $row) {
			...
			echo '<TR>';
				...
				echo '</TD>';
				echo '<TD>';
					echo '<a href="javascript:info('.$row["person_id"].');">';
				...
				echo '</TD>';
				echo '<TD align="center">';
					$rs = getEinzel($row["person_id"],$saisonid,$teamid,"4,5,10,11");
				...
				echo '</TD>';
				echo '<TD align="center">';
					if ($rs["saetzePlus"]!="0" || $rs["saetzeMinus"]!="0") {
						echo $rs["saetzePlus"]." : ".$rs["saetzeMinus"]; 
						$obpk_saetzePlus += $rs["saetzePlus"];
						$obpk_saetzeMinus += $rs["saetzeMinus"];
				...
				echo '<TD align="center">';
					if ($rs["saetzePlus"]!="0" || $rs["saetzeMinus"]!="0") {
						echo $rs["saetzePlus"]." : ".$rs["saetzeMinus"]; 
						$mipk_saetzePlus += $rs["saetzePlus"];
						$mipk_saetzeMinus += $rs["saetzeMinus"];
				...
				echo '<TD align="center">';
					$rs=getEinzel($row["id"],$saisonid,$teamid,"8,9,14,15");
					if ($rs["siege"]!="0" || $rs["niederlagen"]!="0") {
						echo $rs["siege"]." : ".$rs["niederlagen"];
						$siege += $rs["siege"];
						$niederlagen += $rs["niederlagen"];
				...
				echo '<TD align="center">';
					if ($rs["saetzePlus"]!="0" || $rs["saetzeMinus"]!="0") {
						echo $rs["saetzePlus"]." : ".$rs["saetzeMinus"]; 
						$unpk_saetzePlus += $rs["saetzePlus"];
						$unpk_saetzeMinus += $rs["saetzeMinus"];
		...
		foreach ($ersatz as $spielerid) {
			...
			echo '<TR>';
				...
				echo '</TD>';
				echo '<TD>';
					echo '<a href="javascript:info('.$spielerid.');">';
				...
				echo '</TD>';
				echo '<TD align="center">';
					$rs = getEinzel($spielerid,$saisonid,$teamid,"4,5,10,11");
					if ($rs["siege"]!="0" || $rs["niederlagen"]!="0") {
						echo $rs["siege"]." : ".$rs["niederlagen"];
						$siege += $rs["siege"];
						$niederlagen += $rs["niederlagen"];
				...
				echo '<TD align="center">';
					$rs=getEinzel($spielerid,$saisonid,$teamid,"8,9,14,15");
					if ($rs["siege"]!="0" || $rs["niederlagen"]!="0") {
						echo $rs["siege"]." : ".$rs["niederlagen"];
						$siege += $rs["siege"];
						$niederlagen += $rs["niederlagen"];
			...
			echo '<tr>';
				...
				echo '</td>';
				echo '<td align="center">';
					echo $obpk_saetzePlus." : ".$obpk_saetzeMinus;
				echo '</td>';
				...
				echo '</td>';
				echo '<td align="center">';
					echo $mipk_saetzePlus." : ".$mipk_saetzeMinus;
				echo '</td>';
				...
				echo '</td>';
				echo '<td align="center">';
					echo $unpk_saetzePlus." : ".$unpk_saetzeMinus;
				echo '</td>';
		...
		// Ausgabe der Tabelle für die DoppelspielerStatistik
			...
			$niederlagen=0;     		
	     		foreach ($ausgabe as $row) {
	     			echo '<tr>';
	     				echo '<td>';
	     					echo '<a href="javascript:info('.$row["id1"].');">';
	     						echo $row["spieler1"];
	     					echo '<a>';
	     					echo ' / ';
	     					echo '<a href="javascript:info('.$row["id2"].');">';
	     						echo $row["spieler2"];
	     					echo '<a>';
	     				echo '</td>';
					echo '<td align="center">';
