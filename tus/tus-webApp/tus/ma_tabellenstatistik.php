...
////////////////////////
    ...
    $sql3 = 'select * from fb_spiele where saison_id = '.$saisonid.' and gespielt = 1 and spieltag <= '.$spieltag;
...
// Beschriftung
   ...
   $sqlstr="select count(*) anz from fb_zwtab_mannschaft_saison where saison_id=$saisonid";
   ...
   $sqlstr="select name from fb_mannschaft where id=$mannschaftid";
   ...
   $sqlstr="select max(spieltag) spieltag from fb_spiele where saison_id=$saisonid and gespielt=1";
   $result=GetResult($db,$sqlstr);
