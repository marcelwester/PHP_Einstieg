...
?>
	...
	<!--
	        ...
	        {
	        	var url;
	        	url = "ma_spielplan_info_popup.php?spielid="+spielid+"&PHPSESSID='.session_id().'";';;	        	
...
<?php
	$sqlstr  = "select s.spielstaette_id alt_spielstaette,t.spielstaette_id org_spielstaette,s.datum,t.name heim,m.name gast from ";
