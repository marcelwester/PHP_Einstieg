<?php
sitename("tt_start.php",$_SESSION["groupid"]);
// news.php
//
		...
		echo '<TABLE WIDTH="100%" BORDER="0">';
			...
			echo '<TR>';
				echo '<TD VALIGN="TOP" CLASS="eins">';
					$sql = 'select id, datum , heim_id, aus_id from tt_spiele';
			...
			echo '<TR>';
				echo '<TD VALIGN="TOP" CLASS="eins">';
					$sql = 'select id, datum , heim_id, aus_id, heim_tore, aus_tore from tt_spiele';
				...
				echo '</TD>';
				echo '<TD VALIGN="TOP" CLASS="eins">';
					$sql = 'select sb.spiel_id sp_id, sp.datum datum, sp.heim_id heim, sp.aus_id aus from tt_sp_bericht sb , tt_spiele sp ';
