<?php
////
//// fbv_saison_image.php
//// letzte Änderung : Volker, 19.06.2005 
//// was : Erstellung



if (priv("fb_saison_image"))
{
sitename("fbv_saison_image.php",$_SESSION["groupid"]);
?>
...
<?php
			echo 'url = "fbv_saison_image_popup.php?action=add&PHPSESSID='.session_id().'";';
		echo ' else ';
...
<?php
	...
	$_url = 'index.php?site=fbverw&action=saisonimage&PHPSESSID='.session_id();
	...
	echo '<CENTER><TABLE WIDTH="70%" BORDER="0">';
			...
			$sql = 'select team_id,saison_id,a.image_id,spielzeit,liga,startdatum from fb_saison_image a,fb_saison b where closed=0 and saison_id=id';
			...
			foreach ($result as $saison)
			{
		        echo '<TR>';
	                ...
	                echo '</TD>';
	                echo '<TD ALIGN="CENTER" BGCOLOR="#FFFFFF">';
	                        $sqlstr="select name from fb_tus_mannschaft where id=".$saison["team_id"];
