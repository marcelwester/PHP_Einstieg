...
$remote->setUser("vol");
$remote->setPass("12years");
//$remote->setHost("10.3.7.32");   // AC
$remote->setHost("postgres-srv-2.kisters.de");   // AC
//$remote->setHost("10.113.11.62"); // OL 
$remote->setDB("test");
$remote->setPort("5432");
...
// Start Replication
$rep = new DoRep($local->conn(),$remote->conn(),false);  // true ==> Daten werden ohne Konflikterkennung repliziert
